...
// const amSampleTpl: string = require('./pet-date-picker.component.html');

@Component({
  selector: 'app-pet-date-picker',
  template:`
    <div>
        <form [formGroup]="myForm" (ngSubmit)="onSubmitReactiveForms()" novalidate>
            ...
            <div>
                ...
                <!--<p class="error" *ngIf="myForm.myDate.errors?.required && myDate.touched">Date is required!</p>-->
            </div>
        </form>
    </div>
  `,
  styleUrls: ['./pet-date-picker.component.css']
})
export class PetDatePickerComponent implements OnInit {
